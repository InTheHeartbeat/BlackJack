...
{
    public class ConsoleGameInformingOperations
    {
        public void OnRequestBet(Player player)
        {
        ...
        public void OnRequestAction(Player player)
        {
            Console.ForegroundColor = ConsoleConfig.Config.DefaultColor;
            Console.WriteLine();
        ...
        public void OnPlayerWonBlackJack(Player player)
        {
            Console.ForegroundColor = ConsoleConfig.Config.BlackJackColor;
        ...
        public void OnPlayerStandoff(Player player)
        {
